...
function generateAnalysis(item, price, reason) {
  // 0. 시세 데이터 (Massive Tech Intelligence Database - 2025/2026 Baseline)
  const marketPrices = {
    // 📱 Apple iPhone
    '아이폰 16 프로 맥스': 1900000, '아이폰 16 프로': 1550000, '아이폰 16 플러스': 1350000, '아이폰 16': 1250000,
    '아이폰 15 프로 맥스': 1500000, '아이폰 15 프로': 1300000, '아이폰 15': 1050000,
    '아이폰 14 프로': 950000, '아이폰 13': 650000, '아이폰 SE 3': 450000,

    // 📱 Samsung Galaxy
    '갤럭시 S24 울트라': 1698400, '갤럭시 S24 플러스': 1353000, '갤럭시 S24': 1155000,
    '갤럭시 S23 울트라': 1100000, '갤럭시 S23': 850000,
    'Z 폴드 6': 2229700, 'Z 플립 6': 1485000, 'Z 폴드 5': 1500000, 'Z 플립 5': 850000,
    '갤럭시 A55': 550000, '갤럭시 A35': 450000,

    // 💻 Laptops (Official & Market Avg)
    '맥북 프로 16 M4': 3990000, '맥북 프로 14 M4': 2690000,
    '맥북 프로 16 M3': 3490000, '맥북 프로 14 M3': 2390000,
    '맥북 에어 15 M3': 1890000, '맥북 에어 13 M3': 1590000,
    '맥북 에어 M2': 1200000, '맥북 에어 M1': 850000,
    'LG 그램 프로 16': 2500000, 'LG 그램 16': 1900000, 'LG 그램 14': 1600000,
    '갤럭시북 4 프로': 1800000, '갤럭시북 4 울트라': 3000000, '갤럭시북 3': 1100000,

    // ⌚ Wearables & Audio
    '애플워치 울트라 2': 1149000, '애플워치 10': 599000, '애플워치 9': 450000, '애플워치 SE 2': 329000,
    '갤럭시워치 7': 349000, '갤럭시워치 울트라': 899000, '갤럭시워치 6': 250000,
    '에어팟 맥스 2': 769000, '에어팟 맥스': 650000, '에어팟 프로 2': 349000, '에어팟 4': 199000,
    '갤럭시 버즈 3 프로': 319000, '갤럭시 버즈 3': 219000, '소니 WH-1000XM5': 450000,

    // 📑 Tablets
    '아이패드 프로 13 M4': 1999000, '아이패드 프로 11 M4': 1499000,
    '아이패드 에어 6': 899000, '아이패드 미니 7': 799000, '아이패드 10세대': 529000,
    '갤럭시탭 S10 울트라': 1700000, '갤럭시탭 S10+': 1300000, '갤럭시탭 S9': 900000,

    // 🎮 Gaming & Camera
    '플레이스테이션 5 프로': 1118000, '플레이스테이션 5': 688000, 'PS5': 688000,
    '닌텐도 스위치 2': 499000, '닌텐도 스위치 OLED': 415000, '닌텐도 스위치': 360000,
    '스팀덱 OLED': 800000, '로그 엘라이': 900000,
    '소니 A7M4': 3000000, '소니 ZV-E10 II': 1100000, '캐논 R6 Mark II': 3200000,
    '후지필름 X100VI': 2590000, 'DJI 매빅 3 프로': 2900000, 'DJI 미니 4 프로': 1100000,
    '캐논 익서스 750': 400000, '익서스': 350000,

    // 🪑 Furniture & Others (Integrated)
    'IKEA 빌리': 99000, 'IKEA Billy': 99000, '허먼밀러 에어론': 2200000, '시디즈 T50': 350000,
    '커피': 5000, '마라탕': 12000, '치킨': 28000, '피자': 30000, '책': 18000
  };

  const food = ['마라탕', '커피', '치킨', '술', '밥'].some(f => item.includes(f));
  const tech = ['컴퓨터', '맥북', '폰', '아이폰', '갤럭시', '에어팟', '플스', '닌텐도', '카메라', '드론', '익서스', '디카', '워치', '버즈'].some(t => item.includes(t));
