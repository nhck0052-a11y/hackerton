...
function generateAnalysis(item, price, reason) {
  // 0. 시세 데이터 (Expanded Benchmark Prices - 2025 KRW Official/Avg)
  const marketPrices = {
    // 📱 스마트폰 (Phones - Official Launch Price Baseline)
    '아이폰 16 프로 맥스': 1900000, '아이폰16프로맥스': 1900000,
    '아이폰 16 프로': 1550000, '아이폰16프로': 1550000,
    '아이폰 16 플러스': 1350000, '아이폰16플러스': 1350000,
    '아이폰 16': 1250000, '아이폰16': 1250000,
    '아이폰 15 프로': 1550000, '아이폰15프로': 1550000,
    '아이폰 15': 1250000, '아이폰15': 1250000,
    '아이폰 SE': 650000, '아이폰SE': 650000,
    '갤럭시 S24 울트라': 1698400, 'S24 울트라': 1698400, '갤S24울트라': 1698400,
    '갤럭시 S24 플러스': 1353000, 'S24 플러스': 1353000,
    '갤럭시 S24': 1155000, '갤S24': 1155000,
    'Z 폴드 6': 2229700, '제트폴드6': 2229700, '폴드6': 2229700,
    'Z 플립 6': 1485000, '제트플립6': 1485000, '플립6': 1485000,

    // 💻 노트북/PC (Laptops - Official Store Start Price)
    ...
    // ⌚ 웨어러블/태블릿 (Wearables & Tablets)
    '아이패드 프로 13': 1999000, '아이패드 프로 11': 1499000, '아이패드 프로': 1499000,
    '아이패드 에어': 999000, '아이패드 미니': 769000, '아이패드': 529000,
    '갤럭시탭 S9 울트라': 1598300, '갤럭시탭 S9': 998800, '갤탭': 600000,
    '에어팟 맥스': 769000, '에어팟맥스': 769000,
    '에어팟 프로': 359000, '에어팟프로': 359000,
    '에어팟 3': 259000, '에어팟': 200000,
    '갤럭시 버즈 3 프로': 319000, '버즈3프로': 319000, '버즈 3': 219000,
    '애플워치 울트라': 1149000, '애플워치 9': 599000, '애플워치 SE': 329000,
    '갤럭시워치 6': 329000, '갤럭시워치': 300000,

    // 🎮 게임/기타 (Consoles)
    '플레이스테이션 5': 688000, '플스5': 688000, 'PS5': 688000,
    '닌텐도 스위치 OLED': 415000, '닌텐도 스위치': 360000, '스위치': 360000,
    '엑스박스': 688000,

    // ☕ 식음료 (Food & Drink - General)
    '커피': 5000, '아메리카노': 4500, '라떼': 5500, '스무디': 6500,
    '마라탕': 12000, '떡볶이': 15000, '치킨': 28000, '피자': 30000, '햄버거': 10000,
    '국밥': 10000, '김치찌개': 9000, '짜장면': 8000, '탕수육': 20000,
    '삼겹살': 18000, '한우': 50000, '파스타': 18000, '초밥': 25000, '회': 50000,
    '소주': 5000, '맥주': 6000, '빵': 3000, '케이크': 35000, '빙수': 12000,

    // 🏠 생활/패션 (Living & Fashion)
    '택시': 12000, '영화': 15000, '헬스': 50000, '넷플릭스': 17000, '유튜브': 14900,
    '신발': 100000, '운동화': 120000, '가방': 200000, '패딩': 250000
  };
  ...
  const tech = ['컴퓨터', '맥북', '모니터', '키보드', '아이패드', '갤럭시', '아이폰', '에어팟', '워치', '플스', '닌텐도'].some(t => item.includes(t));
  ...
  // 2. 시세 비교 로직 (Smart Analysis - Find Longest Match)
  let marketMatch = null;
  let maxLen = 0;
  for (const key in marketPrices) {
    if (item.replace(/\s/g, '').includes(key.replace(/\s/g, ''))) { // Ignore spaces for matching
